 ...
 * @internal
 */
function createHeader(advertiserName) {
    ...
    advName.textContent = advertiserName !== null && advertiserName !== void 0 ? advertiserName : "Advertiser";
 ...
 * ```
 */
export function renderActionCard(ad, targetElement, requestId) {
 ...
 * ```
 */
export function renderLeadGenCard(ad, targetElement, requestId) {
 ...
 * ```
 */
export function renderStaticCard(ad, targetElement, requestId) {
 ...
 * ```
 */
export function renderFollowupCard(ad, targetElement, requestId) {
 ...
 * ```
 */
export function renderAd(ad, targetElement, requestId) {
    switch (ad.format) {
        case "action_card":
